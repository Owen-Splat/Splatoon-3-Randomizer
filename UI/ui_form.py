...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.beatableCheck.setGeometry(QRect(320, 123, 151, 20))
        self.backgroundCheck = QCheckBox(self.tab)
        self.backgroundCheck.setObjectName(u"backgroundCheck")
        self.backgroundCheck.setGeometry(QRect(40, 173, 151, 20))
        ...
        self.lavaCheck.setGeometry(QRect(560, 123, 151, 20))
        ...
        self.collectCheck.setStyleSheet(u"color: rgb(80, 80, 80);")
        self.collectCheck.setCheckable(False)
...
#if QT_CONFIG(whatsthis)
        self.beatableCheck.setWhatsThis(QCoreApplication.translate("MainWindow", u"Ensures that every level is beatable by keeping the first option vanilla. Every level is given 3 choices regardless", None))
#endif // QT_CONFIG(whatsthis)
